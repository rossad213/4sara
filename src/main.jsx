...
function WelcomeScreen({ onStart, onLogin }) {
  ...
  const LogoMark = ({ compact = false }) => (
    <div className={compact ? "landing-logo-mark compact" : "landing-logo-mark"} aria-hidden="true">
      <span className="landing-petal landing-petal-left" />
      <span className="landing-petal landing-petal-right" />
      <span className="landing-petal landing-petal-center" />
      <span className="landing-petal landing-petal-dark" />
      <span className="landing-drop" />
    </div>
  );
            ...
            <div className="landing-preview-grid">
              ...
              <aside className="landing-preview-stack">
                <div className="landing-phase-card">
                  <span className="mini-lotus"><LogoMark compact /></span>
  ...
  const HomePage = () => (
    <>
      ...
      <section id="privacy" className="landing-section landing-privacy-panel">
        <div className="landing-lock-art" aria-hidden="true">
          <img src="/icon/privacy-lock.png" alt="" />
        </div>
        <div>
